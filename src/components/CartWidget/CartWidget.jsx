...
const CartWidget = () => {
    ...
    return (
        <Link to='/cart'  className='CartWidget' style={{ display: totaQuantity > 0 ? 'block' : 'none'}} >
            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="black" className="bi bi-bag-heart" viewBox="0 0 16 16">
